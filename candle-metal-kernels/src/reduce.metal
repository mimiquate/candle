...
REDUCE(MAX(x, y), fast_max_i64_strided, int64_t, -INFINITY)
...
REDUCE(MIN(x, y), fast_min_i64_strided, int64_t, INFINITY)
...
ARGMIN(fast_argmin_i64_strided, int64_t, INFINITY)
